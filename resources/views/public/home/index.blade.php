...
@section('content')
                ...
                <div class="tw-grid tw-grid-cols-1 tw-gap-8 sm:tw-mx-8 sm:tw-gap-0 lg:tw-mx-auto lg:tw-grid-cols-2 lg:tw-gap-16 xl:tw-mx-auto tablet:tw-mx-24 tablet:tw-gap-0">
                    ...
                    <div class="tw-relative tw-overflow-hidden tw-rounded-lg sm:tw-h-80 lg:tw-order-last lg:tw-h-full">
                        <div id="controls-carousel" class="tw-relative" data-carousel="slide">
                            ...
                            <button type="button" class="group tw-absolute tw-top-0 tw-left-0 tw-z-30 tw-flex tw-h-full tw-cursor-pointer tw-items-center tw-justify-center tw-px-4 focus:tw-outline-none sm:tw-left-5 tablet:tw-left-5" data-carousel-prev>
                            ...
                            <button type="button" class="group tw-absolute tw-top-0 tw-right-0 tw-z-30 tw-flex tw-h-full tw-cursor-pointer tw-items-center tw-justify-center tw-px-4 focus:tw-outline-none sm:tw-right-5 tablet:tw-right-5" data-carousel-next>
                                <span class="tw-inline-flex tw-h-10 tw-w-10 tw-items-center tw-justify-center tw-rounded-full tw-bg-white/30 group-hover:tw-bg-white/50 group-focus:tw-outline-none group-focus:tw-ring-4 group-focus:tw-ring-white dark:tw-bg-gray-800/30 dark:group-hover:tw-bg-gray-800/60 dark:group-focus:tw-ring-gray-800/70">
                                    <svg aria-hidden="true" class="dark:text-gray-800 tw-h-6 tw-w-6 tw-text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    <!-- View Layanan End -->
    <section class="tw-w-full tw-bg-slate-100 tw-pt-12 tw-pb-11 mobile:tw-pt-0">
                ...
                @foreach ($layanan as $items)
                    @if (isset(Auth::user()->id))
                        <div class="tw-mx-2 tw-mb-2 tw-mt-3">
                            <a href="{{ url('/pemesanan/' . $items->slug . '/rekomendasi') }}">
    ...
    <!-- Testimoni Start -->
    <section class="tw-w-full tw-bg-orange tw-pt-12 tw-pb-11">
        <div class="tw-font-poppins tw-container tw-mx-auto">
            ...
            <div class="tw-font-poppins tw-w-full tw-px-4 tw-py-4 tablet:tw-py-4">
                <div class="tw-grid tw-grid-cols-1 tw-gap-8 lg:tw-grid-cols-2 lg:tw-gap-16 tablet:tw-gap-0">
                    <div class="tw-mx-auto tw-overflow-hidden tw-rounded-lg lg:tw-order-last lg:tw-mt-6 lg:tw-h-full">
                        <img alt="Party" src="assets/img/logo-orange.jpg" class="tw-h-full tw-w-full sm:tw-h-[68px] sm:tw-w-[213px] lg:tw-h-[96px] lg:tw-w-[300px] xl:tw-h-[96px] xl:tw-w-[300px] mobile:tw-h-[60px] mobile:tw-w-[188px] tablet:tw-h-[68px] tablet:tw-w-[213px]" />
                    </div>
    ...
    <!-- Mitra Start -->
    <section class="tw-max-h-screen tw-w-full tw-bg-white tw-pt-12 xl:tw-pt-6 mobile:tw-pt-[20px] mobile:tw-pb-[40px]">
        <div class="tw-container tw-mx-auto tw-h-full">
            <div class="tw-font-poppins tw-w-full tw-px-4 tw-py-4 tablet:tw-py-4">
                <div class="tw-grid tw-grid-cols-2 tw-gap-8 sm:tw-mx-8 sm:tw-gap-0 lg:tw-mx-auto lg:tw-gap-0 xl:tw-mx-auto xl:tw-gap-0 mobile:tw-gap-0 tablet:tw-mx-24 tablet:tw-gap-0">
                    ...
                    <div class="tw-mx-auto tw-overflow-hidden tw-rounded-lg lg:tw-order-last lg:tw-mt-6 lg:tw-h-full">
                        <img alt="" src="src/img/jasa.png" class="tw-h-full tw-w-full sm:tw-h-[194px] sm:tw-w-[138px] lg:tw-h-[259px] lg:tw-w-[184px] xl:tw-h-[259px] xl:tw-w-[184px] mobile:tw-h-[147px] mobile:tw-w-[90px] tablet:tw-h-[194px] tablet:tw-w-[138px]" />
                    </div>
                </div>
            </div>
        </div>
    ...
    <section id="artikel" class="tw-w-full tw-bg-slate-100 tw-pt-12 tw-pb-11">
        <div class="tw-font-poppins tw-container tw-mx-auto">
            ...
            <div class="tw-mt-10 tw-w-full tw-px-4">
                <div class="tw-mx-auto tw-mb-12 tw-max-w-xl tw-text-center">
                    <a href="artikel.html" class="tw-rounded-lg tw-bg-orange tw-py-2 tw-px-4 tw-text-base tw-font-medium tw-text-white tw-shadow-lg hover:tw-opacity-80">
