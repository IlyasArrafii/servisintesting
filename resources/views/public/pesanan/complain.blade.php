...
<div class="tw-container tw-mx-auto tw-mt-5">
    <div class="tw-text-center tw-max-w-full">
        <span class="tw-mx-auto tw-text-center tw-font-poppins tw-font-bold">Data Komplain</span>
    </div>
...
<div class="tw-container tw-mx-auto">
    <div class="tw-p-3 tw-mb-10">
        <div class="tw-border-[#fff] tw-bg-[#fff] tw-rounded-xl tw-border tw-mt-1 tw-shadow-sm">
            ...
            <form action="{{url('/kirim-komplain')}}" method="POST">
                ...
                <div class="tw-mx-3 tw-mb-2">
                    <textarea name="komplain" id="komplain" rows="4" class="tw-block tw-p-2.5 tw-w-full tw-text-sm tw-text-gray-900 tw-bg-gray-50 tw-rounded-lg tw-border tw-border-gray-300 focus:tw-ring-blue-500 focus:tw-border-blue-500 dark:tw-bg-gray-700 dark:tw-border-gray-600 dark:tw-placeholder-gray-400 dark:tw-text-white dark:focus:tw-ring-blue-500 dark:tw-focus:border-blue-500" placeholder="deskripsi komplain"></textarea>
                </div>

                @if($jumlahdata < 1) <div class="tw-container tw-mx-auto tw-mt-1 tw-mb-3">
                    <div class="tw-mx-3">
                        <button type="submit" class="tw-w-full tw-px-3 tw-py-2 tw-text-base tw-font-medium tw-text-center tw-text-white tw-bg-orange-400 tw-rounded-lg">Kirim</button>
                    </div>
        </div>
        @endif
