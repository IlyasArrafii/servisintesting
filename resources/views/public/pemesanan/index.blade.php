...
<form action="{{url('/pemesanan/tambah')}}" method="POST">
    ...
    <div class="tw-container">
                ...
                <div class="tw-border-[#fff] tw-bg-[#fff] tw-rounded-xl tw-border tw-mt-1">
                    ...
                    <div class="tw-flex tw-flex-wrap tw-my-2 tw-mt-3">
                        ...
                        <div class="tw-flex tw-w-full tw-mt-3 tw-mb-3">
                            ...
                            <input type="text" name="notelpon" class="tw-mx-3 tw-block tw-px-0 tw-w-full tw-text-sm tw-text-gray-900 tw-bg-transparent tw-border-0 tw-border-b-2 tw-border-gray-300 tw-appearance-none dark:tw-text-white dark:tw-border-gray-600 dark:focus:tw-border-[#ff7f00] focus:tw-outline-none focus:tw-ring-0 focus:tw-border-[#ff7f00] tw-peer" placeholder="Nomor Whatsapp" value="{{Auth::user()->notelpon}}" required />
                        </div>
                        @else
                        <div class="tw-flex tw-w-full">
                            <svg class="tw-text-center tw-ml-4 tw-my-auto" xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" class="bi bi-person-circle" viewBox="0 0 16 16">
                ...
                <div class="tw-border-[#fff] tw-bg-[#fff] tw-rounded-xl tw-border tw-mt-1 tw-mx-3">
                    ...
                    <div class="tw-grid tw-grid-flow-row tw-auto-rows-max tw-gap-2">
                        ...
                        <div class="tw-relative tw-group tw-w-full tw-mx-auto tw-px-3 tw-mb-4">
                            <input type="text" name="detailalamat" class="tw-block tw-px-0 tw-min-w-max tw-w-full tw-text-sm tw-text-gray-900 tw-bg-transparent tw-border-0 tw-border-b-2 tw-border-gray-300 tw-appearance-none dark:tw-text-white dark:tw-border-gray-600 dark:focus:tw-border-[#ff7f00] focus:tw-outline-none focus:tw-ring-0 focus:tw-border-[#ff7f00] tw-peer" placeholder="Detail Alamat (contoh: pagar putih)" />
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="tw-container tw-mx-auto tw-mt-5">
            <div class="tw-border-[#fff] tw-bg-[#fff] tw-rounded-xl tw-border tw-mt-1 tw-mx-3">
                ...
                <div class="tw-grid tw-grid-flow-row tw-auto-rows-max tw-gap-2 tw-mb-3">
                    <div class="tw-relative tw-group tw-w-full tw-mx-auto tw-px-3">
                        <input type="text" name="keluhan" class="tw-block tw-px-0 tw-min-w-max tw-w-full tw-text-sm tw-text-gray-900 tw-bg-transparent tw-border-0 tw-border-b-2 tw-border-gray-300 tw-appearance-none dark:tw-text-white dark:tw-border-gray-600 dark:focus:tw-border-[#ff7f00] focus:tw-outline-none focus:tw-ring-0 focus:tw-border-[#ff7f00] tw-peer" placeholder="Keluhan" required />
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="tw-container tw-mx-auto tw-mt-5">
            <div class="tw-mx-3">
                <button type="submit" class="tw-w-full tw-px-3 tw-py-2 tw-text-base tw-font-medium tw-text-center tw-text-white tw-bg-orange-400 tw-rounded-lg hover:tw-bg-[#ff7f00] dark:tw-bg-orange-400 dark:hover:tw-bg-[#ff7f00]">Langkah Selanjutnya</button>
            </div>
        </div>
        @else
        <div class="tw-container tw-mx-auto tw-mt-5">
            <p class="tw-text-base tw-text-poppins tw-mx-3">Silahkan Login Terlebih Dahulu</p>
            <div class="tw-mx-3">
                <button type="submit" class="tw-w-full tw-px-3 tw-py-2 tw-text-base tw-font-medium tw-text-center tw-text-white tw-bg-orange-400 tw-rounded-lg" disabled>Langkah Selanjutnya</button>
            </div>
        </div>
        @endif
    </div>
