...
<div class="tw-container md:tw-max-w-full jumbotron jumbotron-fluid kotak" style="background-image: url('assets/img/kotak.png');">
    <div class="container">
        ...
        <div class="tw-carousel tw-w-full">
            <div id="" class="tw-carousel-item tw-relative tw-w-full">
                <img src="assets/img/info_promo/promo.png" class="tw-w-full tw-rounded-3xl tw-duration-75" />
            </div>
            <div id="" class="tw-carousel-item tw-relative tw-w-full">
                <img src="assets/img/slide/psby1.png" class="tw-w-full tw-rounded-3xl tw-duration-75" />
            </div>
            <div id="" class="tw-carousel-item tw-relative tw-w-full">
                <img src="assets/img/info_promo/promo.png" class="tw-w-full tw-rounded-3xl tw-duration-75" />
            </div>
    ...
    <div class="tw-mx-auto tw-p-3">
        <div class="tw-bg-[#ff7f00] tw-rounded-3xl tw-px-4 tw-pt-4">
            ...
            <div class="card-promo owl-carousel owl-theme tw-flex">
                ...
                <div class="item">
                    <img src="assets/img/konsumen/1.jpg" class="photo_testi d-block mx-auto">
...
<div class="tw-container md:tw-max-w-full tw-my-3 pendaftaran md:tw-p-3">
    ...
    <div class="tw-mx-auto tw-px-3">
        <div class="tw-p-3 tw-my-4 tw-rounded-lg tw-bg-white tw-font-poppins"> <span class="tops font-weight-bold">Bergabunglah Bersama Kami</span>
