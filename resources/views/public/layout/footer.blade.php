...
<footer class="tw-bg-[#2C2C2C] sm:tw-visible lg:tw-visible xl:tw-visible mobile:tw-visible">
    <div class="tw-mx-auto tw-px-4 tw-pt-16 tw-pb-20 sm:tw-px-8 sm:tw-pb-3 md:tw-px-8 md:tw-pb-3 lg:tw-px-8 lg:tw-pt-24 lg:tw-pb-3">
        <div class="tw-grid tw-grid-cols-1 tw-gap-8 lg:tw-grid-cols-3">
            <div>
                <div class="tw-flex tw-text-left tw-text-teal-600 sm:tw-justify-start">
                ...
                <ul class="tw-mt-8 tw-flex tw-gap-6 tw-text-left sm:tw-justify-start md:tw-gap-8">
                    <li>
                        <a href="https://www.facebook.com/servisin.info" rel="noopener noreferrer" target="_blank" class="tw-text-white tw-transition hover:tw-text-gray-300">
                            <span class="tw-sr-only">Facebook</span>
                            <svg class="tw-h-6 tw-w-6 tw-fill-current" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li>
                        <a href="https://www.instagram.com/servisin_indonesia/" rel="noopener noreferrer" target="_blank" class="tw-text-white tw-transition hover:tw-text-gray-300">
                    ...
                    <li>
                        <a href="https://www.tiktok.com/@servisin" rel="noopener noreferrer" target="_blank" class="tw-text-white tw-transition hover:tw-text-gray-300">
                    ...
                    <li>
                        <a href="https://www.youtube.com/channel/UCR4Y9EIua-HBPUkOeCuYIxg" rel="noopener noreferrer" target="_blank" class="tw-text-white tw-transition hover:tw-text-gray-300">
                    ...
                    <li>
                        <a href="https://wa.me/6285772277727" rel="noopener noreferrer" target="_blank" class="tw-text-white tw-transition hover:tw-text-gray-300">
                            <span class="tw-sr-only">WhatsApp</span>
                            <svg class="tw-h-6 tw-w-6 tw-fill-current" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="tw-grid tw-grid-cols-1 tw-gap-5 sm:tw-grid-cols-2 md:tw-grid-cols-4 lg:tw-col-span-2">
                ...
                <div class="tw-text-left sm:tw-text-left">
                    <p class="tw-font-poppins tw-text-lg tw-font-semibold tw-text-white">Mitra</p>
                ...
                <div class="tw-text-left sm:tw-text-left">
                    <p class="tw-font-poppins tw-text-lg tw-font-semibold tw-text-white">Kontak Kami</p>
                    ...
                    <ul class="tw-mt-6 tw-space-y-4 tw-text-sm">
                        <li>
                            <a class="tw-flex tw-gap-1.5 tw-text-left sm:tw-justify-start" href="mailto:servisinapp@gmail.com" target="_blank" rel="noopener noreferrer">
                                ...
                                <span class="tw-font-poppins tw-text-white tw-transition hover:tw-text-gray-300 md:tw-text-xs">servisinapp@gmail.com</span>
                            </a>
                        </li>
                        ...
                        <li>
                            <a class="tw-flex tw-gap-1.5 sm:tw-justify-start" href="https://wa.me/6285772277727" target="_blank" rel="noopener noreferrer">
                                ...
                                <span class="tw-font-poppins tw-text-white tw-transition hover:tw-text-gray-300 md:tw-text-xs">0857-7227-7727</span>
                            </a>
                        </li>
