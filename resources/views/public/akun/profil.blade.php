                ...
                <div class="tw-flex tw-flex-wrap tw-mx-16">
                    <div class="tw-flex">
                        ...
                        <div class="tw-mx-3 tw-mt-1">
                            <a class="tw-w-full tw-px-3 tw-py-2 tw-text-sm tw-font-medium tw-text-center tw-text-white tw-bg-orange-400 tw-rounded-lg hover:tw-bg-[#ff7f00] dark:tw-bg-orange-400 dark:hover:tw-bg-[#ff7f00] tw-no-underline hover:tw-text-white" :href="route('logout')" onclick="event.preventDefault();
