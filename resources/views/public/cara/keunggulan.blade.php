...
<div class="tw-container md:tw-max-w-full tw-bg-[#ff7f00] tw-px-0 tw-rounded-b-2xl" style="background-color: #ff7f00; padding-top: 5%;">
    <div class="tw-flex tw-pb-2">
        ...
        <div class="tw-text-center tw-mx-auto tw-mr-[37%] md:tw-mx-auto md:tw-mr-[48%] md:tw-text-center">
            <div class="tw-text-center tw-mx-auto">
                <span class="tw-m-auto tw-text-center tw-text-white tw-font-poppins">Keunggulan</span>
            </div>
        </div>
    </div>
</div>

<img src="assets/img/pemilih.png" alt="">
<br>
<br>
<br>